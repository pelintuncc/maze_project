...
import 'package:maze_project/maze_painter.dart';
...
class Maze extends StatefulWidget {
  ...
  Maze({
    ...
    this.width,
    required this.userDefinedWalls,
  });
  ...
  ///Width of the maze
  final double? width;
  final List<List<bool>> userDefinedWalls;
...
class _MazeState extends State<Maze> {
  ...
  void setUp() async {
    ...
    _mazePainter = MazePainter(
      ...
      userDefinedWalls: widget.userDefinedWalls,
